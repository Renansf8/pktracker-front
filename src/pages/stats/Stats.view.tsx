...
/* ─────────────────────────────────────────────────────────────────────────
 * Date helpers
 * Interpret ISO timestamps as *calendar* values in UTC so they align with the
 * bucket semantics returned by the API (which are already day-aligned).
 * ────────────────────────────────────────────────────────────────────────*/
...
/* ── Featured record cards (top section) ─────────────────────────────── */
...
/* ── Bucket cards (profit / loss by range) ──────────────────────────── */
...
export function StatsView({
  ...
  if (isError) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <p className="font-data text-sm tracking-[0.1em] uppercase" style={{ color: "#c44040" }}>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {profitBuckets.map((bucket) => (
            <BucketCard key={`profit-${bucket.range}`} data={bucket} tone="profit" />
          ))}
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {lossBuckets.map((bucket) => (
            <BucketCard key={`loss-${bucket.range}`} data={bucket} tone="loss" />
          ))}
        </div>
      </section>
    </div>
